...
namespace ModernSatsuma.Drawing.SystemDrawing.Tests
{
    public class SystemDrawingGraphicsFactoryTests
    {
        private readonly SystemDrawingGraphicsFactory _factory;

        public SystemDrawingGraphicsFactoryTests()
        {
            _factory = new SystemDrawingGraphicsFactory();
        }
