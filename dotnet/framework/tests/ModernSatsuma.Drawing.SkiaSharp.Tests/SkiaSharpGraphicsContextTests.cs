...
{
    public class SkiaSharpGraphicsContextTests : IDisposable
    {
        private readonly SkiaSharpRenderSurfaceFactory _surfaceFactory;
        private readonly IRenderSurface _surface;
        private readonly IGraphicsContext _context;

        public SkiaSharpGraphicsContextTests()
        {
            _surfaceFactory = new SkiaSharpRenderSurfaceFactory();
