...
namespace ModernSatsuma.Drawing.SkiaSharp.Tests
{
    public class SkiaSharpRenderSurfaceFactoryTests
    {
        private readonly SkiaSharpRenderSurfaceFactory _factory;

        public SkiaSharpRenderSurfaceFactoryTests()
        {
            _factory = new SkiaSharpRenderSurfaceFactory();
        }
        ...
        public void Constructor_ShouldInitializeGraphicsFactory()
        {
            ...
            _factory.GraphicsFactory.Should().BeOfType<SkiaSharpGraphicsFactory>();
        }
