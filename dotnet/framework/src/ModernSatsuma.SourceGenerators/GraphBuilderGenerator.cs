...
namespace ModernSatsuma.Generators;
...
public sealed class GraphBuilderGenerator : IIncrementalGenerator
{
    ...
    private static void EmitGraphBuilder(SourceProductionContext context, Compilation compilation, INamedTypeSymbol builderSymbol, AttributeData graphBuilderAttribute)
    {
        ...
        var defaultGraphTypeSymbol = compilation.GetTypeByMetadataName("ModernSatsuma.CustomGraph");
        var buildableGraphSymbol = compilation.GetTypeByMetadataName("ModernSatsuma.IBuildableGraph");
        ...
        var nodeTypeSymbol = compilation.GetTypeByMetadataName("ModernSatsuma.Node");
        ...
        builder.AppendLine("    private readonly global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, double> _graphBuilderArcCosts = new global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, double>();");
        builder.AppendLine("    private readonly global::System.Collections.Generic.Dictionary<string, global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, double>> _graphBuilderNamedArcCosts = new global::System.Collections.Generic.Dictionary<string, global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, double>>();");
        builder.AppendLine("    private readonly global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, string> _graphBuilderArcTags = new global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, string>();");
        builder.AppendLine();
        builder.AppendLine("    public global::System.Func<global::ModernSatsuma.Arc, double> CreateCostFunction(double defaultCost = 1.0)");
        builder.AppendLine("    {");
        builder.AppendLine("        return arc => _graphBuilderArcCosts.TryGetValue(arc, out var cost) ? cost : defaultCost;");
        builder.AppendLine("    }");
        builder.AppendLine();
        builder.AppendLine("    public global::System.Func<global::ModernSatsuma.Arc, double> CreateCostFunction(string weightName, double defaultCost = 1.0)");
        builder.AppendLine("    {");
        ...
        builder.AppendLine("    }");
        builder.AppendLine();
        builder.AppendLine("    public global::System.Func<global::ModernSatsuma.Arc, string?> CreateTagLookup()");
        builder.AppendLine("    {");
        ...
        builder.AppendLine("        global::ModernSatsuma.Arc arc;");
                ...
                if (costLiteral is not null)
                {
                    ...
                    if (weightNameLiteral is not null)
                    {
                        ...
                        builder.Append("            weights = _graphBuilderNamedArcCosts[")
                            .Append(weightNameLiteral)
                            .Append("] = new global::System.Collections.Generic.Dictionary<global::ModernSatsuma.Arc, double>();")
                            .AppendLine();
                        builder.AppendLine("        }");
        ...
        foreach (var argument in graphBuilderAttribute.NamedArguments)
        {
            if (argument.Key == nameof(GraphBuilderAttribute.DefaultDirectedness))
            {
                ...
                if (value is int intValue)
                {
                    ...
                    {
                        0 => "global::ModernSatsuma.Directedness.Directed",
                        1 => "global::ModernSatsuma.Directedness.Undirected",
                        _ => "global::ModernSatsuma.Directedness.Directed"
                    };
                }
            }
        }

        return "global::ModernSatsuma.Directedness.Directed";
    }
